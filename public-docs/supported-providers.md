...
description: Every coding agent JAgentDesk can launch, natively supported providers and the ACP catalog.
...
For the concept and how JAgentDesk manages providers, see [Providers](/docs/providers). To add or configure your own, see [Custom providers](/docs/custom-providers).
