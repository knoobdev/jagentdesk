...
describe("workspace message schemas", () => {
          ...
          scripts: [
            {
              ...
              port: 3000,
              proxyUrl: "http://web.jagentdesk.localhost:6767",
              lifecycle: "running",
              health: "healthy",
            },
          ],
  ...
  test("preserves a JAgentDesk-owned worktree slug", () => {
    const parsed = WorkspaceDescriptorPayloadSchema.parse({
      id: "owned-worktree",
      projectId: "project",
      projectDisplayName: "repo",
      projectRootPath: "/repo",
      workspaceDirectory: "/jagentdesk/worktrees/project/feature/packages/app",
          ...
          commands: [
            {
              index: 1,
              command: "npm install",
              cwd: "/repo/.jagentdesk/worktrees/feature-a",
              log: "done",
              status: "completed",
              exitCode: 0,
              durationMs: 100,
