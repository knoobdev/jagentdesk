/**
 * Declarative manifest of the git forges JAgentDesk knows how to present, mirroring
...
export interface ForgeDefinition {
  ...
  iconKind: string;
  /** Sign-in recipe, or null when the forge has no JAgentDesk-driven sign-in. */
