...
const MANIFEST_OWNER = "jagentdesk-skills-transaction";
const MANIFEST_FILENAME = "transaction.json";
const TRANSACTION_PREFIX = ".jagentdesk-skills-transaction-";
const RECOVERED_PREFIX = ".jagentdesk-skills-recovered-";
const BACKUP_DIRNAME = "backup";
const MANAGED_FILES_MANIFEST = ".jagentdesk-managed-files.json";
