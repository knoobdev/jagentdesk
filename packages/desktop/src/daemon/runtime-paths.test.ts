...
describe("runtime-paths", () => {
  beforeEach(() => {
    ...
    setProcessRuntime({
      ...
      resourcesPath: "/Applications/JAgentDesk.app/Contents/Resources",
    });
  });
  ...
  it("uses the macOS Helper executable for packaged daemon node launches", () => {
    expect(resolveNodeExecPath()).toBe(
      "/Applications/JAgentDesk.app/Contents/Frameworks/JAgentDesk Helper.app/Contents/MacOS/JAgentDesk Helper",
    );
  });
});
