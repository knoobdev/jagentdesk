...
import { JAgentDeskBrowserWebviewRegistry } from "../browser-webviews/registry.js";
import {
...
const POLICY_INPUT_CHANNEL = "jagentdesk:browser:set-shortcut-policy";
const POLICY_OUTPUT_CHANNEL = "jagentdesk:browser-keyboard-policy";
...
const SHORTCUT_OUTPUT_CHANNEL = "jagentdesk:event:browser-shortcut-input";
const RESERVED_SHORTCUT_OUTPUT_CHANNEL = "jagentdesk:event:browser-shortcut";
...
export class BrowserKeyboard {
  ...
  public constructor(private readonly browserRegistry: JAgentDeskBrowserWebviewRegistry) {}
