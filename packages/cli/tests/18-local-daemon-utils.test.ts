...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("/tmp/jagentdesk.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("unix:///tmp/jagentdesk.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("pipe://\\\\.\\pipe\\jagentdesk-managed-test"), null);
  assert.strictEqual(resolveTcpHostFromListen("\\\\.\\pipe\\jagentdesk-managed-test"), null);
...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("C:\\Users\\foo\\.jagentdesk\\jagentdesk.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("D:\\project\\socket"), null);
  assert.strictEqual(resolveTcpHostFromListen("C:\\jagentdesk.sock"), null);
