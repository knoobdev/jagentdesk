...
const existingProject = join(await mkdtemp(join(tmpdir(), "jagentdesk-open-project-")), "project");
...
const previousDesktopCli = process.env.JAGENTDESK_DESKTOP_CLI;
process.env.JAGENTDESK_DESKTOP_CLI = "1";
...
process.env.JAGENTDESK_DESKTOP_CLI = previousDesktopCli;
