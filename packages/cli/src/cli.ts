...
export function createCli(): Command {
  ...
  program
    .name("jagentdesk")
    .description("JAgentDesk CLI - control your AI coding agents from the command line")
  ...
  addJsonAndDaemonHostOptions(
    program
      .command("clone")
      .description("Clone a GitHub repo and register it as a JAgentDesk workspace")
  ...
  addJsonOption(
    program
      .command("status")
      .description('Show local daemon status (alias for "jagentdesk daemon status")'),
  )
  ...
  addJsonOption(
    program
      .command("restart")
      .description('Restart local daemon (alias for "jagentdesk daemon restart")'),
  )
    .option("--home <path>", "JAgentDesk home directory (default: ~/.jagentdesk)")
