import { z } from "zod";
import { CHECK_TRAIT_ACTION_REQUIRED, CHECK_TRAIT_WARNING } from "@jagentdesk/protocol/check-traits";
import { mapGiteaCommitState } from "@jagentdesk/protocol/gitea-status";
...
/**
 * Probe whether a host is a Gitea instance JAgentDesk can talk to. tea has no
 ...
 * null when there is no usable `tea` login (JAgentDesk cannot operate the host),
