...
import { deriveTerminalActivityStatusBucket } from "@jagentdesk/protocol/terminal-activity";
  ...
  return {
    ...
    async createTerminal(options: {
      ...
      const activityEnv = {
        ...
        JAGENTDESK_ACTIVITY_TOKEN: activityToken,
        ...(terminalActivityUrl ? { JAGENTDESK_TERMINAL_ACTIVITY_URL: terminalActivityUrl } : {}),
      };
