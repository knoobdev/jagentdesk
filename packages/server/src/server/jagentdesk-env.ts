...
export type JAgentDeskNodeEnv = "development" | "production" | "test";
...
export function createJAgentDeskInternalEnv(baseEnv: NodeJS.ProcessEnv): NodeJS.ProcessEnv {
...
export function resolveJAgentDeskNodeEnv(env: NodeJS.ProcessEnv): JAgentDeskNodeEnv | undefined {
  const value = env[JAGENTDESK_NODE_ENV];
