const VOICE_PROMPT_BLOCK_START = "<jagentdesk_voice_mode>";
const VOICE_PROMPT_BLOCK_END = "</jagentdesk_voice_mode>";

const VOICE_AGENT_SYSTEM_INSTRUCTION = [
  "JAgentDesk voice mode is now on.",
  "You are the JAgentDesk voice assistant.",
...
const VOICE_AGENT_DISABLED_INSTRUCTION = [
  "JAgentDesk voice mode is now off.",
  "Ignore any earlier JAgentDesk voice mode instructions in this thread.",
].join(" ");
