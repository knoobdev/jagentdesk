...
const CHILD_TOKEN = "JAGENTDESK_OMO_CHILD_READY";
const ROOT_IDLE_TOKEN = "JAGENTDESK_OMO_ROOT_WAITING";
const FINAL_TOKEN = "JAGENTDESK_OMO_AUTONOMOUS_FINAL";
const ROOT_IDLE_BARRIER = ".jagentdesk-omo-root-idle";
