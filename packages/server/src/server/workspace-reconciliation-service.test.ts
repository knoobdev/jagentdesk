...
describe("WorkspaceReconciliationService", () => {
  ...
  test("keeps legacy duplicate projects and workspace membership intact", async () => {
    ...
    const canonicalWorktreeDir = path.join(repoDir, ".jagentdesk", "worktrees", "focused-bat");
    const duplicateWorktreeDir = path.join(repoDir, ".jagentdesk", "worktrees", "gigantic-blowfish");
