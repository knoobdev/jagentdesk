...
import { defineSettings, settingsRpc, type SettingsDefinition } from "@jagentdesk/plugin";
import type { PluginSettings, PluginSettingsState } from "@jagentdesk/plugin/server";
