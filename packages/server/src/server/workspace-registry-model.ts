...
export type PersistedWorkspacePlacement = Pick<
  ...
  | "worktreeRoot"
  | "baseBranch"
  | "isJAgentDeskOwnedWorktree"
  | "mainRepoRoot"
>;

export type MutableWorkspacePlacement = Pick<
  PersistedWorkspaceRecord,
  "kind" | "branch" | "worktreeRoot" | "isJAgentDeskOwnedWorktree" | "mainRepoRoot"
>;
...
export function initialWorkspacePlacement(
  ...
  return {
    ...
    baseBranch: null,
    isJAgentDeskOwnedWorktree: input.checkout.isGit && input.checkout.isJAgentDeskOwnedWorktree,
...
export function reconcileWorkspacePlacement(input: {
  ...
  if (input.workspace.isJAgentDeskOwnedWorktree !== observed.isJAgentDeskOwnedWorktree)
    fields.isJAgentDeskOwnedWorktree = observed.isJAgentDeskOwnedWorktree;
...
export function checkoutFromPersistedWorkspacePlacement(input: {
  ...
  if (workspace.isJAgentDeskOwnedWorktree && workspace.mainRepoRoot) {
    return {
      ...checkout,
      isGit: true,
      isJAgentDeskOwnedWorktree: true,
...
export function checkoutLiteFromGitSnapshot(
  ...
  if (git.isJAgentDeskOwnedWorktree && git.mainRepoRoot) {
    return {
      cwd,
      isGit: true,
