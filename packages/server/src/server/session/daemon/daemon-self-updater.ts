...
import { npmGlobalJAgentDeskCli, type NpmGlobalJAgentDeskCli } from "./npm-global-cli.js";
...
const DESKTOP_MANAGED_UPDATE_ERROR =
  "This daemon is managed by JAgentDesk Desktop. Update JAgentDesk Desktop on the host.";
