...
// `available_commands_update` session update) translate that payload into JAgentDesk
...
export class ACPAgentSession implements AgentSession, ACPClient {
  ...
  async requestPermission(params: RequestPermissionRequest): Promise<RequestPermissionResponse> {
    ...
    // Match Zed acp.rs:3189-3220 when JAgentDesk is not handling the request locally.
