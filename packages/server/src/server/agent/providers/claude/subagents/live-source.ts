 ...
 *
 * Verified on the wire (Claude Code 2.1.220, JAgentDesk's own query options):
 *
...
export class ClaudeTaskProtocolSource {
   ...
   * value JAgentDesk requested is not necessarily the one that ran, because a model that does not
