...
import { createExternalProcessEnv, type ProcessEnvRecord } from "../jagentdesk-env.js";
export {
...
} from "@jagentdesk/protocol/provider-config";
import {
  ProviderOverrideSchema,
  ProviderOverridesSchema,
  ProviderRuntimeSettingsSchema,
...
// launched from inside Claude Code (e.g. by a JAgentDesk agent), these leak into
