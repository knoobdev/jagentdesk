...
import type { JAgentDeskToolDefinition, JAgentDeskToolResult } from "./types.js";
...
export function addModelVisibleStructuredContent(result: JAgentDeskToolResult): JAgentDeskToolResult {
...
export function serializeJAgentDeskToolInputParameters(
