...
export interface ArchiveIfSafeDependencies {
  ...
  isJAgentDeskOwnedWorktreeCwd: typeof isJAgentDeskOwnedWorktreeCwd;
...
export async function archiveIfSafe(input: {
  ...
  try {
    ...
    const ownership = await deps.isJAgentDeskOwnedWorktreeCwd(cwd, {
      jagentdeskHome: options.jagentdeskHome,
      worktreesRoot: options.jagentdeskWorktreesBaseRoot,
    });
    ...
    try {
      ...
      await deps.archiveByScope(
        {
          jagentdeskHome: options.jagentdeskHome,
          jagentdeskWorktreesBaseRoot: options.jagentdeskWorktreesBaseRoot,
