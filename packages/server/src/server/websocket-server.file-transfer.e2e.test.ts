...
import { createTestJAgentDeskDaemon, type TestJAgentDeskDaemon } from "./test-utils/index.js";
import { WSOutboundMessageSchema, type WSOutboundMessage } from "./messages.js";

const TEST_TIMEOUT_MS = 30_000;
const FILE_SIZE = 8 * 1024 * 1024 + 123;

let daemon: TestJAgentDeskDaemon | undefined;
...
test(
  ...
  async () => {
    const cwd = mkdtempSync(join(tmpdir(), "jagentdesk-large-file-transfer-"));
