...
describe("resolveSpeechConfig", () => {
  test("resolves local-first defaults without env overrides", () => {
    const jagentdeskHome = "/tmp/jagentdesk-home";
    ...
    expect(result.speech.local).toEqual({
      modelsDir: path.join(jagentdeskHome, "models", "local-speech"),
      models: {
  ...
  test("resolves feature-scoped local speech settings", () => {
    ...
    const env = {
      JAGENTDESK_DICTATION_LOCAL_STT_MODEL: "parakeet-tdt-0.6b-v2-int8",
      JAGENTDESK_VOICE_LOCAL_STT_MODEL: "parakeet-tdt-0.6b-v2-int8",
      JAGENTDESK_VOICE_LOCAL_TTS_MODEL: "kokoro-en-v0_19",
      JAGENTDESK_VOICE_LOCAL_TTS_SPEAKER_ID: "5",
      JAGENTDESK_VOICE_LOCAL_TTS_SPEED: "1.35",
      JAGENTDESK_DICTATION_LANGUAGE: "es",
      JAGENTDESK_VOICE_LANGUAGE: "pt",
      JAGENTDESK_LOCAL_MODELS_DIR: "/tmp/models",
      OPENAI_API_KEY: "env-key",
      JAGENTDESK_VOICE_STT_PROVIDER: "openai",
      JAGENTDESK_DICTATION_STT_PROVIDER: "local",
      JAGENTDESK_VOICE_TTS_PROVIDER: "local",
