...
export class ScheduleService {
  ...
  private readonly createJAgentDeskWorktreeWorkspace: (
    input: ScheduleWorkspaceCreateInput,
  ) => Promise<CreateJAgentDeskWorktreeWorkflowResult>;
  ...
  constructor(options: ScheduleServiceOptions) {
    ...
    this.createJAgentDeskWorktreeWorkspace = options.createJAgentDeskWorktreeWorkspace;
  ...
  private async executeSchedule(
    ...
    try {
      ...
      const created = await this.createAgent({
        ...
        labels: {
          "jagentdesk.schedule-id": schedule.id,
          "jagentdesk.schedule-run": runId,
        },
        mode: config.modeId,
