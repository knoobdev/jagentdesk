...
describe("bootstrapWorkspaceRegistries", () => {
  ...
  beforeEach(() => {
    ...
    jagentdeskHome = path.join(tmpDir, ".jagentdesk");
    agentStorage = new AgentStorage(path.join(jagentdeskHome, "agents"), logger);
    projectRegistry = new FileBackedProjectRegistry(
      path.join(jagentdeskHome, "projects", "projects.json"),
      logger,
    );
    workspaceRegistry = new FileBackedWorkspaceRegistry(
      path.join(jagentdeskHome, "projects", "workspaces.json"),
      logger,
    );
