import { createJAgentDeskClient, type JAgentDeskClient } from "@jagentdesk/client";

export function createClient(url: string): JAgentDeskClient {
  return createJAgentDeskClient({
    url,
  });
}
