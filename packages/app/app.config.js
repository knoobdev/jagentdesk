...
const variants = {
  production: {
    name: "JAgentDesk",
    packageId: "app.jagentdesk.mobile",
  ...
  development: {
    name: "JAgentDesk Debug",
    packageId: "app.jagentdesk.mobile.debug",
    googleServicesFile: resolveSecretFile({
...
export default {
  expo: {
    ...
    autolinking: {
      searchPaths: ["./modules", "../../node_modules", "./node_modules"],
    },
    plugins: [
      "expo-router",
