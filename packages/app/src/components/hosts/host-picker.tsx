...
// Tailnet endpoints are shown as tailnet addresses; local loopback remains explicit.
...
// path, so they read as "Local". Network transports show the address being used.
