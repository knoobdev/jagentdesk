...
export function AddHostModal({ visible, onClose, onCancel, onSaved }: AddHostModalProps) {
  ...
  const [port, setPort] = useState(String(DEFAULT_JAGENTDESK_DAEMON_PORT));
  ...
  const clearInput = useCallback(() => {
    setHost("");
    setPort(String(DEFAULT_JAGENTDESK_DAEMON_PORT));
    setUseTls(false);
    setPassword("");
      ...
      <View style={styles.portRow}>
        ...
        <View style={portFieldStyle}>
          ...
          <AdaptiveTextInput
            ...
            placeholder={String(DEFAULT_JAGENTDESK_DAEMON_PORT)}
            placeholderTextColor={theme.colors.foregroundMuted}
            style={styles.input}
            autoCapitalize="none"
            autoCorrect={false}
      ...
      <View style={styles.field}>
        ...
        {isAdvancedOpen ? (
          <AdaptiveTextInput
            ...
            placeholder={`tcp://localhost:${DEFAULT_JAGENTDESK_DAEMON_PORT}?ssl=true`}
            placeholderTextColor={theme.colors.foregroundMuted}
            style={styles.input}
            autoCapitalize="none"
            autoCorrect={false}
