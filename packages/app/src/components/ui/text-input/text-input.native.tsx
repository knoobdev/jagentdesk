...
// JAgentDesk ships no native paste module, so pasted images are not intercepted on native
// (onPasteImages / onPasteError are accepted for API parity and never called here).
