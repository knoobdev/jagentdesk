...
export function DatabaseChatDock({
  ...
  // Closed. On desktop the dock is toggled from the explorer toolbar's "Ask AI"
  // button and the split layout has no room for an edge affordance, so render
  // nothing. On phones the data view fills the screen and there's no persistent
