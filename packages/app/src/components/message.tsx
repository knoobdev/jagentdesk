...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_ID = "jagentdesk-toolcall-shimmer-keyframes";
const WEB_TOOLCALL_SHIMMER_ANIMATION_NAME = "jagentdesk-toolcall-shimmer";
...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_CSS = `
  @keyframes ${WEB_TOOLCALL_SHIMMER_ANIMATION_NAME} {
    0% {
      background-position: var(--jagentdesk-shimmer-start, -200px) 0;
    }
    100% {
      background-position: var(--jagentdesk-shimmer-end, 200px) 0;
    }
  }
`;
...
function buildShimmerTextStyle(input: {
  ...
  return inlineUnistylesStyle({
    ...
    "--jagentdesk-shimmer-start": `${input.webShimmerTrackStart - input.offsetX}px`,
    "--jagentdesk-shimmer-end": `${input.webShimmerTrackEnd - input.offsetX}px`,
  });
}
