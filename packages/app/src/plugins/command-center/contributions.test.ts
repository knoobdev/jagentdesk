...
import { type PluginCommandCenterItemContribution } from "@jagentdesk/plugin/client";
...
const workspace: PluginWorkspaceSnapshot = {
  ...
  directory: "/repo/jagentdesk/review",
  projectKind: "git",
  kind: "worktree",
  name: "Review",
  title: null,
...
describe("plugin Command Center contributions", () => {
  ...
  it("supplies the direct API, typed RPC, snapshots, and narrow navigation", async () => {
    ...
    expect(receivedJAgentDesk).toBe(runtime.jagentdesk);
