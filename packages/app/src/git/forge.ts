 ...
 * as before.
 */
import { FORGE_DEFINITIONS, getForgeDefinitionOrNeutral } from "@jagentdesk/protocol/forge-manifest";
import { normalizeHost, parseGitRemoteLocation } from "@jagentdesk/protocol/git-remote";
import type { ForgeAuthState } from "@jagentdesk/protocol/messages";
import {
  buildForgeBlobUrl,
...
export interface ForgePresentation {
  ...
  /** Auth CLI binary for the install hint, or null for a forge with no JAgentDesk-driven sign-in. */
