...
import type { CheckoutPipelineJob, CheckoutPrMergeMethod } from "@jagentdesk/protocol/messages";
import {
  CHECK_TRAIT_ACTION_REQUIRED,
  CHECK_TRAIT_MANUAL,
  CHECK_TRAIT_WARNING,
} from "@jagentdesk/protocol/check-traits";
import { GITLAB_ACTIVE_PIPELINE_STATUS_SET } from "@jagentdesk/protocol/gitlab-pipeline";
