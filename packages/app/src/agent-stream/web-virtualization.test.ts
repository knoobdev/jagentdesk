...
describe("web virtualization test overrides", () => {
  it("uses defaults unless explicit positive integer overrides are present", () => {
    ...
    try {
      ...
      globalWithOverrides.__JAGENTDESK_E2E_WEB_PARTIAL_VIRTUALIZATION_THRESHOLD = 6;
      globalWithOverrides.__JAGENTDESK_E2E_WEB_MOUNTED_RECENT_STREAM_ITEMS = 4;
      ...
      if (previousMounted === undefined) {
        ...
        globalWithOverrides.__JAGENTDESK_E2E_WEB_MOUNTED_RECENT_STREAM_ITEMS = previousMounted;
      }
    }
  });
});
