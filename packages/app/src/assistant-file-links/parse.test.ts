...
describe("parseAssistantFileLink", () => {
  ...
  it("keeps tilde hrefs as direct home-relative file targets", () => {
    expect(
      parseAssistantFileLink("~/.jagentdesk/plans/file-preview.md", {
        workspaceRoot: "/Users/test/project",
      }),
    ).toEqual({
      raw: "~/.jagentdesk/plans/file-preview.md",
      path: "~/.jagentdesk/plans/file-preview.md",
      lineStart: undefined,
      lineEnd: undefined,
    });
    expect(
      parseAssistantFileLink("~/.jagentdesk/plans/file-preview.md:12", {
        workspaceRoot: "/Users/test/project",
      }),
    ).toEqual({
      raw: "~/.jagentdesk/plans/file-preview.md:12",
      path: "~/.jagentdesk/plans/file-preview.md",
      lineStart: 12,
      lineEnd: undefined,
    });
...
describe("normalizeInlinePathTarget", () => {
  ...
  it("keeps tilde paths as home-relative file targets", () => {
    expect(
      normalizeInlinePathTarget("~/.jagentdesk/plans/file-preview.md", "/Users/test/project"),
    ).toEqual({
      directory: "~/.jagentdesk/plans",
      file: "~/.jagentdesk/plans/file-preview.md",
    });
  });
