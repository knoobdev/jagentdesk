...
import type { TerminalInputModeState } from "@jagentdesk/protocol/terminal-input-mode";
...
declare global {
  interface Window {
    ...
    __JAGENTDESK_TERMINAL_WEBVIEW_RECEIVE__?: (message: InboundMessage) => void;
    __JAGENTDESK_TERMINAL_WEBVIEW_BLUR__?: () => void;
  }
}
...
const TERMINAL_BACKGROUND_CSS_VAR = "--jagentdesk-terminal-background";
...
window.__JAGENTDESK_TERMINAL_WEBVIEW_RECEIVE__ = bridge.receive;
window.__JAGENTDESK_TERMINAL_WEBVIEW_BLUR__ = bridge.blur;
