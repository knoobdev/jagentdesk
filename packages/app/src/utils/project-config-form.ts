import type {
  JAgentDeskConfigRaw,
  JAgentDeskMetadataGeneration,
  JAgentDeskMetadataGenerationEntry,
  JAgentDeskScriptEntryRaw,
...
export interface ProjectScriptDraft {
  ...
  type: string;
  portText: string;
  rawEntry: JAgentDeskScriptEntryRaw;
}
...
export interface ProjectConfigDraft {
  ...
  metadataGenerationBase: JAgentDeskMetadataGeneration | undefined;
}
...
export function configToDraft(config: JAgentDeskConfigRaw | null | undefined): ProjectConfigDraft {
...
interface ApplyDraftInput {
  ...
  base: JAgentDeskConfigRaw | null | undefined;
}

export function applyDraftToConfig(input: ApplyDraftInput): JAgentDeskConfigRaw {
  ...
  const nextScripts: Record<string, JAgentDeskScriptEntryRaw> = {};
  for (const row of input.draft.scripts) {
    ...
    nextScripts[trimmedName] = nextEntry as JAgentDeskScriptEntryRaw;
  }
  ...
  return result as JAgentDeskConfigRaw;
}
