import { parseHostPort } from "@jagentdesk/protocol/daemon-endpoints";
...
export type WorkspaceScriptLinkKind = "public" | "jagentdesk" | "direct";
...
export function resolveWorkspaceScriptLink(input: {
  ...
  addTarget(targets, "jagentdesk", localProxyUrl);
