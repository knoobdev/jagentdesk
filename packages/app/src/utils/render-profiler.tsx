...
const onRender: ProfilerOnRenderCallback = (
  ...
  globalThis.__JAGENTDESK_RENDER_PROFILE__ ??= [];
  globalThis.__JAGENTDESK_RENDER_PROFILE__.push({
    id,
    phase,
    actualDuration,
    baseDuration,
...
export function RenderProfile({ id, children }: { id: string; children: ReactNode }) {
  ...
  globalThis.__JAGENTDESK_RENDER_PROFILE__ ??= [];
  globalThis.__JAGENTDESK_RENDER_PROFILE_REASONS__ ??= {};
  globalThis.__JAGENTDESK_RESET_RENDER_PROFILE__ = () => {
    globalThis.__JAGENTDESK_RENDER_PROFILE__ = [];
    globalThis.__JAGENTDESK_RENDER_PROFILE_REASONS__ = {};
  };
...
export function recordRenderProfileReasons(id: string, reasons: string[]) {
  ...
  globalThis.__JAGENTDESK_RENDER_PROFILE_REASONS__ ??= {};
  const counts = (globalThis.__JAGENTDESK_RENDER_PROFILE_REASONS__[id] ??= {});
