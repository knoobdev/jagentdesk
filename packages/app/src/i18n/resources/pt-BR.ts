...
export const ptBR: TranslationResources = {
  ...
  pairing: {
    ...
    remoteSsh: {
      title: "SSH remoto",
      helper: "Conecte-se a um daemon JAgentDesk no host remoto.",
      fields: {
        target: "Host SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Leia como o relay do JAgentDesk funciona",
      ...
      updateRequired: "Atualize o host para ativar o relay pelo JAgentDesk Desktop.",
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "O JAgentDesk entregou a notificação ao sistema operacional.",
    ...
    metadataGeneration: {
      ...
      description:
        "Escolha o modelo usado pelo JAgentDesk para títulos de espaços de trabalho, nomes de branches, mensagens de commit e rascunhos de pull request",
      selection: "Seleção de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "O JAgentDesk escolhe um modelo rápido disponível",
      preferredHint: "Escolha o modelo que o JAgentDesk usa",
      model: "Modelo",
      fallbackHint: "Se ele não estiver disponível, o JAgentDesk usa outro modelo disponível",
      docs: "Documentação",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Isso atualiza o JAgentDesk neste computador",
    ...
    project: {
      ...
      worktree: {
        ...
        uncommittedTitle: "Faça commit das alterações no jagentdesk.json",
