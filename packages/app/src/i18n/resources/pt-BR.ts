...
export const ptBR: TranslationResources = {
  ...
  workspace: {
    route: {
      ...
      tailnetNeedsLogin: "Este host pode exigir que você faça login no Tailscale novamente.",
      localRetriesExhaustedTitle: "Não foi possível acessar {{hostName}}",
      localRetriesExhaustedDescription:
        "Este host local falhou ao conectar após 3 tentativas. Remova e recrie para tentar de novo.",
      localRetriesExhaustedAction: "Remover e recriar",
      localRetriesExhaustedConfirm:
        "Não foi possível acessar este host local após 3 tentativas. Remover e recriar?",
      recovery: {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Arquivar não está disponível aqui porque este workspace não foi criado como um worktree do JAgentDesk",
          mergePrNoForge:
  ...
  connection: {
    localMode: {
      mobileWarning:
        "O modo Local está ativado. Dispositivos móveis não conseguem se conectar a este computador via Tailscale até você voltar ao modo Tailscale.",
    },
    timingOut: {
      tailnet: {
        title: "{{hostName}} não conectou",
        message:
          "Este host estava expirando pelo Tailscale. Faça login no Tailscale novamente para restaurar a conexão.",
        action: "Entrar novamente",
      },
      local: {
        title: "{{hostName}} não conectou",
        message:
          "As informações de repetição deste host local não foram encontradas. Remova e recrie para reconectar.",
        action: "Remover e recriar",
      },
    },
  },
  migration: {
    moveDataTitle: "Mover dados para outro host",
    moveDataAction: "Mover dados…",
    moveDataHint:
      "Move os agentes deste host e seus dados para outro host conectado. Os itens migrados mostram o nome deste host como prefixo.",
    pickTarget: "Escolha um host de destino",
    pickTargetHint: "Os dados são movidos para o host que você escolher aqui.",
    noTargets: "Conecte outro host para mover dados para ele.",
    notConnected: "Esse host não está conectado no momento. Reconecte-o e tente novamente.",
    confirmTitle: "Mover dados?",
    confirmMessage:
      "Mover agentes e dados de {{source}} para {{target}}? Os itens migrados mostrarão um rótulo {{source}} em {{target}}.",
    confirmAction: "Mover dados",
    success: "{{count}} agentes movidos deste host para {{target}}.",
    failed: "Não foi possível mover os dados. Nada foi alterado.",
    recreateHealed: "{{hostName}} reconectado.",
    recreateSuccess: "{{hostName}} recriado e seus dados movidos.",
    recreateFailed: "Não foi possível acessar {{hostName}} para recriá-lo. Ele foi mantido.",
  },
  sidebar: {
    pinned: {
      title: "Fixados",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Permitir que o JAgentDesk inicie e pare o daemon integrado",
        ...
        registrationFailed:
          "O daemon integrado foi iniciado, mas o JAgentDesk não conseguiu salvar a conexão localhost. Desative e reative o gerenciamento do daemon ou adicione localhost manualmente.",
        pausedStopFailed:
          "O gerenciamento do daemon integrado foi pausado, mas o JAgentDesk não conseguiu parar o daemon.",
        updateFailed: "Não foi possível atualizar o gerenciamento do daemon integrado.",
      },
      keepRunning: {
        title: "Manter daemon em execução ao sair",
        hint: "O daemon continua em execução quando você sai do JAgentDesk",
      },
      logs: {
      ...
      fullStatus: {
        ...
        hint: "Executa `jagentdesk daemon status` e mostra a saída",
        view: "Ver status",
    ...
    permissions: {
      ...
      testNotification: {
        title: "Teste de notificação do JAgentDesk",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Não foi possível instalar a CLI do JAgentDesk.",
      },
      skills: {
  ...
  rootError: {
    ...
    title: "O JAgentDesk encontrou um problema.",
  ...
  startup: {
    ...
    errorDescription:
      "O servidor local falhou ao iniciar. Se isso continuar acontecendo, reporte o problema e inclua os logs abaixo.",
    logs: {
  ...
  pairing: {
    connectionMethods: {
      ...
      scanQr: {
        ...
        description: "Conexão via tailnet.",
      },
      pasteLink: {
    ...
    direct: {
      title: "Conexão direta",
      helper: "Informe o endereço de um servidor JAgentDesk.",
      fields: {
        host: "Host",
        port: "Porta",
        password: "Senha",
    ...
    device: {
      ...
      hint: "Escaneie este QR code com o JAgentDesk no seu celular ou copie o link abaixo.",
  ...
  toolCallGroup: {
    ...
    jagentdeskCalls: {
      one: "chamou o JAgentDesk {{count}} vez",
      other: "chamou o JAgentDesk {{count}} vezes",
    },
    and: "e",
  },
  renameModal: {
  ...
  settings: {
    ...
    general: {
      ...
      browserData: {
        ...
        description: "As abas do navegador compartilham logins e dados de sites no JAgentDesk.",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "Atualizar JAgentDesk skills?",
        updateFallback: "Sincronize as skills incluídas com sua máquina.",
        uninstallTitle: "Desinstalar JAgentDesk skills?",
        uninstallMessage:
          "Remove todas as skills de orquestração do JAgentDesk de ~/.agents, ~/.claude e ~/.codex.",
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Ativar ferramentas do JAgentDesk",
          hint: "Agentes poderão gerenciar worktrees, agentes e agendamentos",
          accessibilityLabel: "Injetar ferramentas do JAgentDesk",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este host está offline. O JAgentDesk reconecta automaticamente. Aguarde ele voltar a ficar online antes de reiniciar.",
          requestFailedTitle: "Erro",
          requestFailedMessage:
            "Falha ao enviar a solicitação de reinício. O JAgentDesk reconecta automaticamente. Tente novamente quando o host aparecer como online.",
          dialogFailedMessage: "Não foi possível abrir o diálogo de confirmação de reinício.",
        },
        update: {
          desktopManagedHint:
            "Este daemon é gerenciado pelo JAgentDesk Desktop. Atualize o JAgentDesk Desktop no host.",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "Não foi possível analisar jagentdesk.json",
        ...
        transportTitle: "Não foi possível carregar jagentdesk.json",
        transportFallback: "O host não respondeu.",
        failedTitle: "Não foi possível carregar jagentdesk.json",
      ...
      metadata: {
        ...
        info: "Instruções específicas do projeto injetadas nos prompts de IA que o JAgentDesk usa para gerar metadados. Use-as para aplicar convenções da sua equipe, como nomes de branch, estilo de commit ou formato de PR",
      ...
      writeFailures: {
        ...
        staleDescription: "Recarregue para buscar o jagentdesk.json mais recente antes de salvar.",
        failedTitle: "Não foi possível salvar jagentdesk.json",
  ...
  marketplace: {
    ...
    states: {
      ...
      errorTitle: "Couldn't load the marketplace",
      retry: "Retry",
      offline: "Connect to a host to install plugins.",
    },
    install: {
