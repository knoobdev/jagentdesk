...
export const fr: TranslationResources = {
  ...
  startup: {
    ...
    errorDescription:
      "Le serveur local n'a pas pu démarrer. Si cela continue, veuillez signaler le problème et inclure les journaux ci-dessous.",
    logs: {
  ...
  pairing: {
    connectionMethods: {
      ...
      scanQr: {
        ...
        description: "Connexion via le tailnet.",
      },
      pasteLink: {
