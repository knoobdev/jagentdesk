...
export const fr: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "L'archive n'est pas disponible ici car cet espace de travail n'a pas été créé en tant qu'arbre de travailJAgentDesk",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "LaissezJAgentDeskdémarrer et arrêter le démon intégré",
        ...
        pausedStopFailed:
          "La gestion du démon intégré a été suspendue, maisJAgentDeskn'a ​​pas pu arrêter le démon.",
      ...
      keepRunning: {
        ...
        hint: "Daemoncontinue de fonctionner lorsque vous quittezJAgentDesk",
      },
      logs: {
      ...
      fullStatus: {
        ...
        hint: "Exécute`jagentdesk daemon status`et affiche la sortie",
    ...
    rosetta: {
      ...
      runningIntel: "Vous exécutez la versionInteldeJAgentDesksousRosettasurApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Test de notificationJAgentDesk",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Impossible d'installer leJAgentDeskCLI.",
      },
    },
  },
  rootError: {
    title: "JAgentDesk a rencontré un problème.",
  ...
  pairing: {
    ...
    direct: {
      title: "Connexion directe",
      helper: "Saisissez l'adresse d'un serveurJAgentDesk.",
      fields: {
        host: "Host",
        port: "Port",
    ...
    remoteSsh: {
      title: "SSH distant",
      helper: "Connectez-vous à un daemon JAgentDesk sur l’hôte distant.",
      fields: {
        target: "Hôte SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Lire comment fonctionne le relais JAgentDesk",
      ...
      updateRequired: "Mettez à jour l’hôte pour activer le relais depuis JAgentDesk Desktop.",
      unavailable: "Offre de jumelage indisponible.",
      hint: "Scannez ce codeQRavecJAgentDesksur votre téléphone ou copiez le lien ci-dessous.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    jagentdeskCalls: {
      one: "a appelé JAgentDesk {{count}} fois",
      other: "a appelé JAgentDesk {{count}} fois",
    },
    and: "et",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "JAgentDesk a transmis la notification au système d’exploitation.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choisissez le modèle utilisé par JAgentDesk pour les titres d’espaces de travail, les noms de branches, les messages de commit et les brouillons de pull request",
      selection: "Sélection du modèle",
      automatic: "Automatique",
      preferred: "Manuel",
      automaticHint: "JAgentDesk choisit un modèle rapide disponible",
      preferredHint: "Choisissez le modèle utilisé par JAgentDesk",
      model: "Modèle",
      fallbackHint: "S’il est indisponible, JAgentDesk utilise un autre modèle disponible",
      docs: "Documentation",
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Les onglets du navigateur partagent les connexions et les données des sites dans JAgentDesk.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Cela met à jourJAgentDesksur cet ordinateur",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Mettre à jour les compétencesJAgentDesk?",
        updateFallback: "Synchronisez les compétences regroupées sur votre machine.",
        uninstallTitle: "Désinstaller les compétencesJAgentDesk?",
        uninstallMessage:
          "Supprime toutes les compétences d'orchestrationJAgentDeskde ~/.agents, ~/.claude, ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Activer les outilsJAgentDesk",
          hint: "Les agents pourront gérer les arbres de travail, les agents et les horaires",
          accessibilityLabel: "Injecter les outilsJAgentDesk",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Cet hôte est hors ligne.JAgentDeskse reconnecte automatiquement: attendez qu'il soit de nouveau en ligne avant de redémarrer.",
          requestFailedTitle: "Erreur",
          requestFailedMessage:
            "Échec de l'envoi de la demande de redémarrage.JAgentDeskse reconnecte automatiquement - réessayez une fois que l'hôte apparaît comme en ligne.",
          dialogFailedMessage:
            "Impossible d'ouvrir la boîte de dialogue de confirmation de redémarrage.",
        },
        update: {
          desktopManagedHint:
            "Ce daemon est géré par JAgentDesk Desktop. Mettez à jour JAgentDesk Desktop sur l’hôte.",
          title: "Update daemon",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "jagentdesk.json n'a pas pu être analysé",
        ...
        transportTitle: "Impossible de charger jagentdesk.json",
        transportFallback: "L'hôte n'a pas répondu.",
        failedTitle: "Impossible de charger jagentdesk.json",
      ...
      worktree: {
        ...
        uncommittedTitle: "Validez les modifications de jagentdesk.json",
      ...
      scripts: {
        ...
        serviceHint: "JAgentDesksupervise le processus et attribue un port via $JAGENTDESK_PORT",
        actions: {
      ...
      metadata: {
        title: "Génération de métadonnées",
        info: "Instructions spécifiques au projet injectées dans les invites de l'IA queJAgentDeskutilise pour générer des métadonnées: utilisez-les pour appliquer les conventions de votre équipe telles que la dénomination des branches, le style de validation ou le formatPR.",
