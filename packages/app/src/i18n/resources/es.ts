...
export const es: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "El archivo no está disponible aquí porque este espacio de trabajo no se creó como un árbol de trabajoJAgentDesk",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Deje queJAgentDeskinicie y detenga el demonio incorporado",
        ...
        pausedStopFailed:
          "La gestión del demonio integrado se pausó, peroJAgentDeskno pudo detener el demonio.",
      ...
      keepRunning: {
        ...
        hint: "Daemonsigue ejecutándose cuando sales deJAgentDesk",
      },
      logs: {
      ...
      fullStatus: {
        ...
        hint: "Ejecuta`jagentdesk daemon status`y muestra la salida.",
        view: "Ver estado",
    ...
    rosetta: {
      ...
      runningIntel: "Estás ejecutando la compilaciónInteldeJAgentDeskenRosettaenApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Prueba de notificaciónJAgentDesk",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "No se puede instalar elJAgentDeskCLI.",
      },
    },
  },
  rootError: {
    title: "JAgentDesk tuvo un problema.",
  ...
  pairing: {
    ...
    direct: {
      title: "Conexión directa",
      helper: "Ingrese la dirección de un servidorJAgentDesk.",
      fields: {
        host: "Host",
        port: "Puerto",
        password: "Contraseña",
    ...
    remoteSsh: {
      title: "SSH remoto",
      helper: "Conéctate a un daemon de JAgentDesk en el host remoto.",
      fields: {
        target: "Host SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Leer cómo funciona el relé de JAgentDesk",
      ...
      updateRequired: "Actualice el host para habilitar el relé desde JAgentDesk Desktop.",
      unavailable: "Oferta de maridaje no disponible.",
      hint: "Escanee este códigoQRconJAgentDesken su teléfono o copie el enlace a continuación.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    jagentdeskCalls: {
      one: "llamó a JAgentDesk {{count}} vez",
      other: "llamó a JAgentDesk {{count}} veces",
    },
    and: "y",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "JAgentDesk entregó la notificación al sistema operativo.",
    ...
    metadataGeneration: {
      ...
      description:
        "Elige el modelo que JAgentDesk usa para títulos de espacios de trabajo, nombres de ramas, mensajes de commit y borradores de pull requests",
      selection: "Selección de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "JAgentDesk elige un modelo rápido disponible",
      preferredHint: "Elige el modelo que usa JAgentDesk",
      model: "Modelo",
      fallbackHint: "Si no está disponible, JAgentDesk usa otro modelo disponible",
      docs: "Documentación",
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Las pestañas del navegador comparten inicios de sesión y datos de sitios en JAgentDesk.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Esto actualizaJAgentDesken esta computadora.",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "¿Actualizar las habilidades deJAgentDesk?",
        updateFallback: "Sincronice las habilidades incluidas con su máquina.",
        uninstallTitle: "¿Desinstalar las habilidadesJAgentDesk?",
        uninstallMessage:
          "Elimina todas las habilidades de orquestaciónJAgentDeskde ~/.agents, ~/.claude, ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Habilitar herramientasJAgentDesk",
          hint: "Los agentes podrán gestionar árboles de trabajo, agentes y horarios.",
          accessibilityLabel: "Inyectar herramientasJAgentDesk",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este anfitrión está desconectado.JAgentDeskse vuelve a conectar automáticamente; espere hasta que vuelva a estar en línea antes de reiniciar.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "No se pudo enviar la solicitud de reinicio.JAgentDeskse vuelve a conectar automáticamente; inténtelo nuevamente una vez que el host se muestre en línea.",
          dialogFailedMessage:
            "No se puede abrir el cuadro de diálogo de confirmación de reinicio.",
        },
        update: {
          desktopManagedHint:
            "Este daemon está administrado por JAgentDesk Desktop. Actualiza JAgentDesk Desktop en el host.",
          title: "Update daemon",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "jagentdesk.json no se pudo analizar",
        ...
        transportTitle: "No se pudo cargar jagentdesk.json",
        transportFallback: "El anfitrión no respondió.",
        failedTitle: "No se pudo cargar jagentdesk.json",
      ...
      worktree: {
        ...
        uncommittedTitle: "Confirma los cambios de jagentdesk.json",
      ...
      scripts: {
        ...
        serviceHint: "JAgentDesksupervisa el proceso y asigna un puerto vía $JAGENTDESK_PORT",
        actions: {
          add: "Agregar guión",
          edit: "Editar",
          remove: "Eliminar",
      ...
      metadata: {
        title: "Generación de metadatos",
        info: "Instrucciones específicas del proyecto inyectadas en los mensajes de IA queJAgentDeskutiliza para generar metadatos; úselas para hacer cumplir las convenciones de su equipo, como la denominación de ramas, el estilo de confirmación o el formatoPR.",
