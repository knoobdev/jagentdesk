...
export const es: TranslationResources = {
  ...
  startup: {
    ...
    errorDescription:
      "El servidor local no pudo iniciarse. Si esto continúa sucediendo, informe el problema e incluya los registros a continuación.",
    logs: {
  ...
  pairing: {
    connectionMethods: {
      ...
      scanQr: {
        ...
        description: "Conexión a través de tailnet.",
      },
      pasteLink: {
  ...
  marketplace: {
    ...
    themes: {
      ...
      empty: "Ningún tema coincide con este filtro.",
      filter: { all: "Todos" },
      appearance: { dark: "Oscuro", light: "Claro" },
    },
    states: {
