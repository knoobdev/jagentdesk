...
export const ar: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "الأرشيف غير متاح هنا لأنه لم يتم إنشاء مساحة العمل هذه كشجرة عمل JAgentDesk",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "اسمح لـ JAgentDesk ببدء تشغيل البرنامج الخفي المدمج وإيقافه",
        ...
        pausedStopFailed:
          "تم إيقاف إدارة البرنامج الخفي المضمنة مؤقتًا، لكن لم يتمكن JAgentDesk من إيقاف البرنامج الخفي.",
        updateFailed: "غير قادر على تحديث إدارة البرنامج الخفي المضمنة.",
      },
      keepRunning: {
        title: "استمر في تشغيل البرنامج الخفي بعد الإقلاع عن التدخين",
        hint: "يستمر تشغيل Daemon عند إنهاء JAgentDesk",
      },
      logs: {
        title: "ملف السجل",
      ...
      fullStatus: {
        ...
        hint: "يقوم بتشغيل`jagentdesk daemon status`ويظهر الإخراج",
        view: "عرض الحالة",
    ...
    rosetta: {
      ...
      runningIntel: "أنت تقوم بتشغيل إصدار Intel من JAgentDesk ضمن Rosetta على Apple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "اختبار الإخطار JAgentDesk",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "غير قادر على تثبيت JAgentDeskCLI.",
      },
    },
  },
  rootError: {
    title: "واجه JAgentDesk مشكلة.",
  ...
  pairing: {
    ...
    direct: {
      title: "اتصال مباشر",
      helper: "أدخل عنوان خادم JAgentDesk.",
      fields: {
        host: "Host",
        port: "ميناء",
    ...
    remoteSsh: {
      title: "SSH عن بُعد",
      helper: "الاتصال بخادم JAgentDesk يعمل على المضيف البعيد.",
      fields: {
        target: "مضيف SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "اقرأ كيفية عمل تتابع JAgentDesk",
      ...
      updateRequired: "حدّث المضيف لتمكين التتابع من JAgentDesk Desktop.",
      unavailable: "عرض الاقتران غير متاح.",
      hint: "قم بمسح رمز QR هذا باستخدام JAgentDesk على هاتفك، أو انسخ الرابط أدناه.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    jagentdeskCalls: {
      one: "استدعى JAgentDesk {{count}} مرة",
      other: "استدعى JAgentDesk {{count}} مرات",
    },
    and: "و",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "سلّم JAgentDesk الإشعار إلى نظام التشغيل.",
    ...
    metadataGeneration: {
      ...
      description:
        "اختر النموذج الذي يستخدمه JAgentDesk لعناوين مساحات العمل وأسماء الفروع ورسائل الالتزام ومسودات طلبات السحب",
      selection: "اختيار النموذج",
      automatic: "تلقائي",
      preferred: "يدوي",
      automaticHint: "يختار JAgentDesk نموذجًا سريعًا متاحًا",
      preferredHint: "اختر النموذج الذي يستخدمه JAgentDesk",
      model: "النموذج",
      fallbackHint: "إذا لم يكن متاحًا، يستخدم JAgentDesk نموذجًا آخر متاحًا",
      docs: "الوثائق",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "تتشارك علامات تبويب المتصفح تسجيلات الدخول وبيانات المواقع عبر JAgentDesk.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "يؤدي هذا إلى تحديث JAgentDesk على هذا الكمبيوتر",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "تحديث مهارات JAgentDesk ؟",
        updateFallback: "مزامنة المهارات المجمعة لجهازك.",
        uninstallTitle: "إلغاء تثبيت مهارات JAgentDesk ؟",
        uninstallMessage: "يزيل جميع مهارات تنسيق JAgentDesk من ~/.agents ، ~/.claude ، ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "تمكين أدوات JAgentDesk",
          hint: "سيتمكن الوكلاء من إدارة أشجار العمل والوكلاء والجداول الزمنية",
          accessibilityLabel: "حقن أدوات JAgentDesk",
        },
        systemPrompt: {
          title: "موجه النظام",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "هذا المضيف غير متصل.  يقوم JAgentDesk بإعادة الاتصال تلقائيًا - انتظر حتى يتم الاتصال بالإنترنت مرة أخرى قبل إعادة التشغيل.",
          requestFailedTitle: "خطأ",
          requestFailedMessage:
            "فشل في إرسال طلب إعادة التشغيل.  يقوم JAgentDesk بإعادة الاتصال تلقائيًا - حاول مرة أخرى بمجرد ظهور المضيف على أنه متصل بالإنترنت.",
          dialogFailedMessage: "غير قادر على فتح مربع حوار تأكيد إعادة التشغيل.",
        },
        update: {
          desktopManagedHint:
            "يدير JAgentDesk Desktop هذا البرنامج الخفي. حدّث JAgentDesk Desktop على المضيف.",
          title: "Update daemon",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "تعذر تحليل jagentdesk.json",
        ...
        transportTitle: "تعذر تحميل jagentdesk.json",
        transportFallback: "المضيف لم يستجب.",
        failedTitle: "تعذر تحميل jagentdesk.json",
      ...
      worktree: {
        ...
        uncommittedTitle: "ثبّت تغييرات jagentdesk.json",
      ...
      scripts: {
        ...
        serviceHint: "يشرف JAgentDesk على العملية ويعين منفذًا عبر $JAGENTDESK_PORT",
        actions: {
      ...
      metadata: {
        ...
        info: "تعليمات خاصة بالمشروع يتم إدخالها في الذكاء الاصطناعي الذي يستخدمه JAgentDesk لإنشاء بيانات التعريف - استخدمها لفرض اصطلاحات فريقك مثل تسمية الفرع أو نمط الالتزام أو تنسيق PR",
      ...
      writeFailures: {
        ...
        staleDescription: "أعد التحميل لجلب أحدث ملف jagentdesk.json قبل الحفظ.",
        failedTitle: "تعذر حفظ jagentdesk.json",
