export const en = {
  ...
  pairing: {
    ...
    remoteSsh: {
      title: "Remote SSH",
      helper: "Connect to a JAgentDesk daemon running on the remote host.",
      fields: {
        target: "SSH host",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Read how JAgentDesk relay works",
      ...
      updateRequired: "Update the host to enable relay from JAgentDesk Desktop.",
      unavailable: "Pairing offer unavailable.",
      hint: "Scan this QR code with JAgentDesk on your phone, or copy the link below.",
      securityWarning:
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "JAgentDesk handed the notification to the operating system.",
    ...
    plugins: {
      ...
      idHint: "Leave blank to use jagentdesk-plugin.json",
    ...
    metadataGeneration: {
      ...
      description:
        "Choose the model JAgentDesk uses for workspace titles, branch names, commit messages, and pull request drafts",
      selection: "Model selection",
      automatic: "Automatic",
      preferred: "Manual",
      automaticHint: "JAgentDesk picks a fast available model",
      preferredHint: "Choose the model JAgentDesk uses",
      model: "Model",
      fallbackHint: "If it is unavailable, JAgentDesk falls back to another available model",
      docs: "Docs",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "This updates JAgentDesk on this computer",
    ...
    host: {
      ...
      skills: {
        ...
        uninstallMessage:
          "Removes all JAgentDesk orchestration skills from ~/.agents, ~/.claude, ~/.codex on this host.",
    ...
    project: {
      ...
      worktree: {
        ...
        uncommittedTitle: "Commit jagentdesk.json changes",
