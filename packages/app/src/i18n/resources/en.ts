...
export const en = {
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Let JAgentDesk start and stop the built-in daemon",
        ...
        pausedStopFailed:
          "Built-in daemon management was paused, but JAgentDesk could not stop the daemon.",
        updateFailed: "Unable to update built-in daemon management.",
      },
      keepRunning: {
        title: "Keep daemon running after quit",
        hint: "Daemon keeps running when you quit JAgentDesk",
      },
      logs: {
        title: "Log file",
      ...
      fullStatus: {
        ...
        hint: "Runs `jagentdesk daemon status` and shows the output",
        view: "View status",
    ...
    rosetta: {
      ...
      runningIntel: "You're running the Intel build of JAgentDesk under Rosetta on Apple Silicon.",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Unable to install the JAgentDesk CLI.",
      },
      skills: {
  ...
  rootError: {
    ...
    title: "JAgentDesk ran into a problem.",
  ...
  startup: {
    ...
    errorDescription:
      "The local server failed to start. If this keeps happening, please report the issue and include the logs below.",
    logs: {
  ...
  tailscaleLogin: {
    ...
    awaitingConnection: "Connecting to Tailscale…",
    awaitingConnectionHint:
      "Finish signing in, then return here. Connecting to your tailnet — this can take a few seconds.",
    connecting:
    ...
    authKeyInProgress: "Joining...",
    errorRequired: "Enter an auth key",
    errorFailed:
      "Couldn't connect to Tailscale. Check that this device and your computer are on the same tailnet, then try again.",
    sameTailnetNote: "This device must be on the same tailnet as the computer running JAgentDesk.",
    overviewHint:
      "Join your tailnet so this desktop can be reached by your other JAgentDesk devices.",
    overviewStatusChecking: "Checking connection...",
    overviewStatusConnected: "Connected",
    overviewStatusConnecting: "Connecting...",
    overviewStatusNeedsLogin: "Needs sign-in",
    overviewStatusUnavailable: "Unavailable",
    overviewConnectTitle: "Connect this desktop",
    overviewConnectHint: "Sign in to Tailscale or join with an auth key.",
    overviewConnectAction: "Connect with Tailscale",
    overviewManageTitle: "Tailscale is connected",
    overviewManageHint: "Review or refresh the desktop's Tailscale connection.",
    overviewManageAction: "Manage connection",
    manageTitle: "Tailscale connection",
    manageSubtitle: "Review the Tailscale connection for this desktop.",
    manageConnectedTitle: "Tailscale is connected",
    manageConnectedHint: "This desktop is ready to be reached by your other JAgentDesk devices.",
    manageRefreshAction: "Refresh status",
    manageChecking: "Checking Tailscale connection...",
    backToOverview: "Back to Overview",
    unavailableTitle: "Tailscale is not available",
    unavailableBody:
      "This build has no Tailscale native module. Install a build with Tailscale support, or connect over your local network with a direct connection.",
  },
  modelSelector: {
  ...
  pairing: {
    connectionMethods: {
      ...
      scanQr: {
        title: "Scan QR code",
        description: "Tailnet connection.",
      },
      pasteLink: {
    ...
    direct: {
      title: "Direct connection",
      helper: "Enter the address of a JAgentDesk server.",
      fields: {
        host: "Host",
        port: "Port",
        password: "Password",
    ...
    device: {
      ...
      hint: "Copy this link or scan the QR code. After the mobile device joins Tailscale, this desktop will show a connection request popup with the six-digit code.",
  ...
  toolCallGroup: {
    ...
    jagentdeskCalls: {
      one: "called JAgentDesk {{count}} time",
      other: "called JAgentDesk {{count}} times",
    },
    and: "and",
  },
  renameModal: {
  ...
  settings: {
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Browser tabs share sign-ins and site data across JAgentDesk.",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "Update JAgentDesk skills?",
        updateFallback: "Sync bundled skills to your machine.",
        uninstallTitle: "Uninstall JAgentDesk skills?",
        uninstallMessage:
          "Removes all JAgentDesk orchestration skills from ~/.agents, ~/.claude, ~/.codex.",
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Enable JAgentDesk tools",
          hint: "Agents will be able to manage worktrees, agents and schedules",
          accessibilityLabel: "Inject JAgentDesk tools",
        },
        systemPrompt: {
          title: "System prompt",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "This host is offline. JAgentDesk reconnects automatically-wait until it's back online before restarting.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "Failed to send the restart request. JAgentDesk reconnects automatically-try again once the host shows as online.",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "jagentdesk.json couldn't be parsed",
        ...
        transportTitle: "Couldn't load jagentdesk.json",
        transportFallback: "The host didn't respond.",
        failedTitle: "Couldn't load jagentdesk.json",
      ...
      scripts: {
        ...
        serviceHint: "JAgentDesk supervises the process and assigns a port via $JAGENTDESK_PORT",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
      ...
      metadata: {
        ...
        info: "Project-specific instructions injected into the AI prompts JAgentDesk uses to generate metadata - use them to enforce your team's conventions like branch naming, commit style, or PR format",
      ...
      writeFailures: {
        ...
        staleDescription: "Reload to fetch the latest jagentdesk.json before saving.",
        failedTitle: "Couldn't save jagentdesk.json",
