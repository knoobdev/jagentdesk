...
export const ru: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Архив здесь недоступен, поскольку это рабочее пространство не было создано как рабочее дерево JAgentDesk.",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Позвольте JAgentDesk запустить и остановить встроенный демон.",
      ...
      keepRunning: {
        ...
        hint: "Daemon продолжает работать, когда вы выходите из JAgentDesk",
      },
      logs: {
        title: "Файл журнала",
      ...
      fullStatus: {
        ...
        hint: "Запускает`jagentdesk daemon status`и показывает результат",
    ...
    rosetta: {
      ...
      runningIntel: "Вы используете сборку Intel для JAgentDesk под Rosetta на Apple Silicon.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Невозможно установить JAgentDeskCLI.",
      },
      skills: {
  ...
  startup: {
    ...
    errorDescription:
      "Локальный сервер не удалось запустить. Если это повторяется, сообщите о проблеме и приложите журналы ниже.",
    logs: {
  ...
  pairing: {
    connectionMethods: {
      ...
      scanQr: {
        ...
        description: "Подключение через tailnet.",
      },
      pasteLink: {
    ...
    device: {
      ...
      hint: "Отсканируйте этот код QR с помощью JAgentDesk на своем телефоне или скопируйте ссылку ниже.",
  ...
  toolCallGroup: {
    ...
    jagentdeskCalls: {
      one: "JAgentDesk вызван {{count}} раз",
      other: "JAgentDesk вызван {{count}} раз",
    },
    and: "и",
  },
  renameModal: {
  ...
  settings: {
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Вкладки браузера используют общие данные входа и данные сайтов в JAgentDesk.",
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          ...
          accessibilityLabel: "Инструменты внедрения JAgentDesk",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Этот хост не в сети.JAgentDesk автоматически повторно подключается — подождите, пока он снова подключится к сети, прежде чем перезапускаться.",
          requestFailedTitle: "Ошибка",
          requestFailedMessage:
            "Не удалось отправить запрос на перезапуск.JAgentDesk автоматически повторно подключается. Повторите попытку, как только хост окажется в сети.",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "jagentdesk.json не удалось разобрать",
      ...
      scripts: {
        ...
        serviceHint: "JAgentDesk контролирует процесс и назначает порт через $JAGENTDESK_PORT.",
        actions: {
          add: "Добавить скрипт",
          edit: "Редактировать",
          remove: "Удалять",
      ...
      metadata: {
        ...
        info: "Инструкции для конкретного проекта, внедренные в подсказки ИИ, которые JAgentDesk использует для генерации метаданных. Используйте их для обеспечения соблюдения соглашений вашей команды, таких как наименование ветвей, стиль фиксации или формат PR.",
      ...
      writeFailures: {
        ...
        staleDescription:
          "Перед сохранением перезагрузите компьютер, чтобы получить последнюю версию файла jagentdesk.json.",
