...
export const ru: TranslationResources = {
  ...
  workspace: {
    ...
    scripts: {
      ...
      routes: {
        ...
        jagentdesk: "Запоминающийся адрес",
        direct: "Прямой адрес",
      },
      states: {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Архивирование недоступно: это рабочее пространство не было создано как worktree JAgentDesk.",
  ...
  desktop: {
    ...
    quitting: {
      title: "Завершение работы JAgentDesk...",
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Разрешить JAgentDesk запускать и останавливать встроенный демон",
        ...
        registrationFailed:
          "Встроенный демон запущен, но JAgentDesk не удалось сохранить подключение к localhost. Выключите и снова включите управление демоном или добавьте localhost вручную.",
        pausedStopFailed:
          "Встроенное управление демоном было приостановлено, но JAgentDesk не смог остановить демон.",
        updateFailed: "Не удалось изменить настройки управления встроенным демоном.",
      },
      keepRunning: {
        title: "Продолжать работу демона после выхода",
        hint: "Демон продолжит работать после выхода из JAgentDesk",
      },
      logs: {
        title: "Файл журнала",
      ...
      fullStatus: {
        ...
        hint: "Выполняет команду `jagentdesk daemon status` и показывает результат",
    ...
    rosetta: {
      ...
      runningIntel: "Вы используете сборку JAgentDesk для Intel через Rosetta на Apple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Тест уведомлений JAgentDesk",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Не удалось установить JAgentDesk CLI.",
      },
    },
  },
  rootError: {
    title: "В JAgentDesk возникла проблема.",
  ...
  onboarding: {
    title: "Добро пожаловать в JAgentDesk",
  ...
  pairing: {
    ...
    direct: {
      title: "Прямое подключение",
      helper: "Введите адрес сервера JAgentDesk.",
      fields: {
        host: "Хост",
        port: "Порт",
        password: "Пароль",
    ...
    remoteSsh: {
      title: "Удалённый SSH",
      helper: "Подключитесь к демону JAgentDesk на удалённом хосте.",
      fields: {
        target: "Хост SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Узнать, как работает ретранслятор JAgentDesk",
      ...
      updateRequired: "Обновите хост, чтобы включить ретранслятор из JAgentDesk Desktop.",
      unavailable: "Данные для сопряжения недоступны.",
      hint: "Отсканируйте этот QR-код с помощью JAgentDesk на телефоне или скопируйте ссылку ниже.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    jagentdeskCalls: {
      one: "выполнен {{count}} вызов JAgentDesk",
      other: "выполнены вызовы JAgentDesk ({{count}})",
    },
    and: "и",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "JAgentDesk передал уведомление операционной системе.",
    ...
    metadataGeneration: {
      ...
      description:
        "Выберите модель, которую JAgentDesk будет использовать для названий рабочих пространств и веток, сообщений коммитов и черновиков PR",
      selection: "Выбор модели",
      automatic: "Автоматически",
      preferred: "Вручную",
      automaticHint: "JAgentDesk выбирает быструю доступную модель",
      preferredHint: "Выберите модель, которую использует JAgentDesk",
      model: "Модель",
      fallbackHint: "Если она недоступна, JAgentDesk использует другую доступную модель",
      docs: "Документация",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Вкладки браузера в JAgentDesk используют общие данные входа и данные сайтов.",
    ...
    about: {
      ...
      releaseChannel: {
        label: "Канал выпуска",
        description:
          "Переключитесь на бета-канал, чтобы раньше получать обновления и помогать развивать JAgentDesk.",
        stable: "Стабильный",
        beta: "Бета",
      },
      updates: {
        ...
        installMessage: "Это обновит JAgentDesk на этом компьютере.",
    ...
    host: {
      ...
      skills: {
        ...
        uninstallMessage:
          "Удаляет все навыки оркестрации JAgentDesk из ~/.agents, ~/.claude и ~/.codex на этом хосте.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Включить инструменты JAgentDesk",
          hint: "Агенты смогут управлять worktree, агентами и расписаниями.",
          accessibilityLabel: "Добавить инструменты JAgentDesk",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Этот хост не в сети. JAgentDesk переподключится автоматически. Дождитесь подключения перед перезапуском.",
          requestFailedTitle: "Ошибка",
          requestFailedMessage:
            "Не удалось отправить запрос на перезапуск. JAgentDesk переподключается автоматически. Повторите попытку, когда хост появится в сети.",
          dialogFailedMessage: "Не удалось открыть диалог подтверждения перезапуска.",
        },
        update: {
          desktopManagedHint:
            "Этот демон управляется JAgentDesk Desktop. Обновите JAgentDesk Desktop на хосте.",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "Не удалось разобрать jagentdesk.json",
        ...
        transportTitle: "Не удалось загрузить jagentdesk.json.",
        transportFallback: "Хост не ответил.",
        failedTitle: "Не удалось загрузить jagentdesk.json.",
      ...
      worktree: {
        ...
        uncommittedTitle: "Закоммитьте изменения в jagentdesk.json",
      ...
      scripts: {
        ...
        serviceHint: "JAgentDesk управляет процессом и назначает порт через переменную $JAGENTDESK_PORT.",
        actions: {
          add: "Добавить скрипт",
          edit: "Редактировать",
          remove: "Удалить",
      ...
      metadata: {
        title: "Генерация метаданных",
        info: "Инструкции для этого проекта, добавляемые в промпты ИИ, с помощью которых JAgentDesk генерирует метаданные. Используйте их, чтобы соблюдать принятые в команде правила именования веток, оформления коммитов и формата PR.",
      ...
      writeFailures: {
        ...
        staleDescription: "Перед сохранением загрузите с диска последнюю версию jagentdesk.json.",
        failedTitle: "Не удалось сохранить jagentdesk.json.",
        failedDescription: "Повторите попытку или загрузите с диска последнюю версию jagentdesk.json.",
      },
      actions: {
