...
import type { JAgentDeskSubagentRow, ProviderSubagentRow, SubagentRow } from "./select";
import {
...
function row(
  overrides: Partial<JAgentDeskSubagentRow> & Pick<JAgentDeskSubagentRow, "id">,
): JAgentDeskSubagentRow {
  return {
    kind: "jagentdesk",
    id: overrides.id,
