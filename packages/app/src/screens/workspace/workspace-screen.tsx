...
import { getOpenAgentTabLabel } from "@jagentdesk/protocol/agent-labels";
import {
  memo,
  useCallback,
  useEffect,
...
export const WorkspaceScreen = memo(function WorkspaceScreen({
  ...
  useEffect(() => {
    traceInstant("jagentdesk.workspace.mount", { serverId, workspaceId });
    return () => {
      traceInstant("jagentdesk.workspace.unmount", { serverId, workspaceId });
    };
