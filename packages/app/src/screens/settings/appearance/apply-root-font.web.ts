...
const STYLE_ID = "jagentdesk-ui-font";
const RULE =
  ":is(#root, #overlay-root) *:not([data-pmono]):not([data-pmono] *){font-family:var(--jagentdesk-ui-font);}";
...
export function applyRootUiFont(uiFontStack: string): void {
  ...
  document.documentElement.style.setProperty("--jagentdesk-ui-font", value);
