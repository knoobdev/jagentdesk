...
function ProjectSettingsBody({
  ...
  const loadedConfig: JAgentDeskConfigRaw | null = data?.ok ? (data.config ?? {}) : null;
  const loadedRevision: JAgentDeskConfigRevision | null = data?.ok ? data.revision : null;
...
interface RenderContentInput {
  ...
  loadedConfig: JAgentDeskConfigRaw | null;
  loadedRevision: JAgentDeskConfigRevision | null;
...
function revisionToKey(revision: JAgentDeskConfigRevision | null): string {
...
interface ProjectConfigFormProps {
  baseConfig: JAgentDeskConfigRaw;
  revision: JAgentDeskConfigRevision | null;
  repoRoot: string;
  queryKey: readonly [string, string, string];
  client: DaemonClient;
  onReload: () => void;
