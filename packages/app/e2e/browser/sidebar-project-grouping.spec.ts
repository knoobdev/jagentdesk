...
const GROUPED_PROJECT_NAME = "jagentdesk-e2e/grouped-project";
const SHARED_REMOTE_URL = "https://github.com/jagentdesk-e2e/grouped-project.git";
...
async function removePersistedProjectKeys(host: IsolatedHostDaemon): Promise<void> {
  const projectsPath = path.join(host.jagentdeskHome, "projects", "projects.json");
