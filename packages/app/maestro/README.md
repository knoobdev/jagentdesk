...
Start the `app.jagentdesk.mobile.debug` dev client against the intended Metro server first;
...
working with `${JAGENTDESK_MAESTRO_*}` placeholders.
...
The scripts assume a development build with package id `app.jagentdesk.mobile.debug`, an
