...
OUT_DIR="/tmp/jagentdesk-workspace-create-android-focus-$(date +%s)"
VIDEO_DIR="/tmp/jagentdesk-maestro-videos"
DEVICE_VIDEO="/sdcard/jagentdesk-maestro-workspace-create-focused.mp4"
