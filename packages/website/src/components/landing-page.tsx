...
const SOCIAL_PROOF_TWEETS = [
  ...
  },
  {
    ...
    text: "JAgentDesk is a really good interface for Pi. It’s not the only thing it does, but that’s my current use case for now.",
  },
  {
    name: "Dong",
    handle: "@dongnaebi",
    ...
    text: "JAgentDesk is the best software I've used this year. Absolutely amazing!",
  },
] as const;
  ...
  return (
    ...
    >
      <SectionTitle
        ...
        description="See what developers are saying about JAgentDesk"
      />
...
function TurnkeySection() {
  return (
    <FeatureSection
      ...
      description="Use JAgentDesk locally, from another machine, or with a team"
    >
        ...
        <div className="p-6 md:p-8">
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <TurnkeyExtensionCard
              ...
              description="Run JAgentDesk on a home lab, or a cloud machine"
...
function AutomationSection() {
  ...
  return (
    <FeatureSection
      ...
      description="Use MCP, the CLI, or the TypeScript SDK to automate JAgentDesk"
  ...
  return (
    <div className="font-mono text-[11px] leading-5 text-white/60">
      <div className="space-y-6">
        <div>
          <ShellPrompt>
            <span className="text-white">jagentdesk run</span> <span className="text-white/35">\</span>
          </ShellPrompt>
          <div className="pl-5">
        ...
        <div className="space-y-1">
          <ShellPrompt>
            <span className="text-white">jagentdesk ls</span>
          </ShellPrompt>
          <AgentListOutput />
        </div>
...
function SdkAutomationExample() {
  return (
    <pre className="overflow-x-auto font-mono text-[11px] leading-5 text-white/60">
      <span className="text-purple-300">import</span> {"{"} createJAgentDeskClient {"}"}{" "}
      <span className="text-purple-300">from</span>{" "}
      <span className="text-emerald-300/80">{'"@jagentdesk/client"'}</span>;{"\n\n"}
      <span className="text-purple-300">const</span> client ={" "}
      <span className="text-sky-300">createJAgentDeskClient</span>({"{"}
      ...
      <span className="text-emerald-300/80">{'"/Users/me/dev/jagentdesk"'}</span>,{"\n"} prompt:{" "}
...
function ExtensibleSection() {
  return (
    <FeatureSection title="Make it yours" description="Extend JAgentDesk to work just the way you want">
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <ExtensibleCard
          icon={GitFork}
          title="Fork the repo"
          description="JAgentDesk is licensed under Apache 2.0. You can inspect the implementation, fork the project, and adapt it to your workflow or organization"
    ...
    <div ref={containerRef} className="flex flex-col items-center pt-4 pb-16 gap-20">
      ...
      >
        ...
        <motion.div
          ...
          role="img"
          aria-label="JAgentDesk workspace drawer"
        >
        ...
        <motion.div
          ...
          role="img"
          aria-label="JAgentDesk agent chat"
        >
        ...
        <motion.div
          ...
          className="w-[160px] md:w-[240px] absolute"
          role="img"
          aria-label="JAgentDesk diff view"
        >
    ...
    >
      ...
      <div className="space-y-6">
        <FAQItem question="Is this free?">
          Yes. JAgentDesk is free and open source. You need agent providers installed with your own
        ...
        <FAQItem question="What agents does it support?">
          JAgentDesk supports many providers. It has custom implementations for Claude, Codex, OpenCode,
        ...
        <FAQItem question="How does JAgentDesk run providers?">
          JAgentDesk runs the providers installed on your machine as you&apos;d normally run them. JAgentDesk
        ...
        <FAQItem question="Can I connect from outside my network?">
          Yes. You can use the hosted relay (end-to-end encrypted, JAgentDesk can&apos;t read your
        ...
        <FAQItem question="Can I get banned for using JAgentDesk?">
          JAgentDesk is designed to use each provider&apos;s officially supported integration and does
  ...
  return (
    ...
    >
      <div className="text-sm text-muted-foreground leading-relaxed space-y-3">
        <p>JAgentDesk is an independent open source project for running coding agents.</p>
        ...
        <p>I am hoping that you will enjoy JAgentDesk as much as I do.</p>
        <p>If you like JAgentDesk, sponsorship is the best way to support continued development.</p>
        <p>- Mo</p>
      </div>
      <div className="pt-2">
        <a
