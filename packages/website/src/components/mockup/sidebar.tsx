...
import { JAgentDeskMark } from "./icons";
...
const JAGENTDESK: Avatar = { kind: "jagentdesk" };
...
const DONE_ROWS: WorkspaceRow[] = [
  { id: "beta", title: "Release v0.7.0-beta.2", avatar: JAGENTDESK, time: "2h" },
  {
    id: "blank-page-focus",
  ...
  { id: "resume", title: "Resume in-progress work", avatar: JAGENTDESK, time: "3d" },
  { id: "undef", title: "Undefined task", avatar: JAGENTDESK, time: "3d" },
  { id: "codex-issue", title: "Diagnose cloud/Codex issue re…", avatar: JAGENTDESK, time: "4d" },
  { id: "cws", title: "Diagnose create_workspace 37…", avatar: JAGENTDESK, time: "4d" },
  { id: "taps", title: "Diagnose tap interactions", avatar: JAGENTDESK, time: "4d" },
  { id: "clarify", title: "Clarify task requirements", avatar: JAGENTDESK, time: "5d" },
  { id: "abc", title: "Task for abcdefghi", avatar: JAGENTDESK, time: "5d" },
];
