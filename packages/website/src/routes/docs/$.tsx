...
export const Route = createFileRoute("/docs/$")({
  head: ({ params }) => {
    ...
    if (!doc) return pageMeta("Not Found - JAgentDesk Docs", "Doc not found.", path);
    return pageMeta(`${doc.frontmatter.title} - JAgentDesk Docs`, doc.frontmatter.description, path);
  },
  component: DocsPage,
});
