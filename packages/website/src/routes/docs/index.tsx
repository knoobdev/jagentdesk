...
export const Route = createFileRoute("/docs/")({
  head: () => {
    ...
    if (!doc)
      return pageMeta(
        "Docs - JAgentDesk",
        "Install JAgentDesk and start running coding agents from your phone, desktop, and terminal.",
        "/docs",
      );
    return pageMeta(`${doc.frontmatter.title} - JAgentDesk Docs`, doc.frontmatter.description, "/docs");
  },
  component: DocsIndex,
});
