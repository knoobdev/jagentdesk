...
export const Route = createFileRoute("/privacy")({
  head: () =>
    pageMeta(
      ...
      "What stays on your machines, what the encrypted relay can see, and what JAgentDesk Hub stores.",
      "/privacy",
    ),
  component: Privacy,
});
...
function Privacy() {
  return (
    <LegalPage title="Privacy Policy" lastUpdated="August 29, 2026">
      <p>
        JAgentDesk is local-first. Installing or using the open-source software does not send us your
        code, prompts, files, terminal output, or agent conversations. This policy explains the
        separate data boundaries for local JAgentDesk, the optional official relay, the hosted JAgentDesk Hub,
        and jagentdesk.local.
      </p>
      ...
      <section>
        ...
        <p>
          ...
          official JAgentDesk website, relay, and hosted Hub. Independently self-hosted daemons, Hubs,
          and relays are controlled by their operators and are not covered by this policy.
        </p>
      </section>

      <section>
        <h2>Local JAgentDesk apps and daemons</h2>
        <p>
          JAgentDesk runs on your machines. It does not send us analytics, telemetry, advertising
        ...
        <p>
          ...
          credentials on your machine. JAgentDesk does not manage or intercept those provider API calls.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          JAgentDesk controls account, billing, security, and service-operation data. When an
          organization uses Hub to process personal data in its workflows, that organization decides
          why the data is processed and JAgentDesk processes it on the organization&apos;s behalf.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          service can guarantee absolute security. Read JAgentDesk&apos;s{" "}
          <a
            href="https://github.com/jagentdesk/jagentdesk/blob/main/SECURITY.md"
            target="_blank"
