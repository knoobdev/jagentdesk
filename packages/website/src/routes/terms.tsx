...
import { LegalPage, JAgentDeskLegalIdentity } from "~/components/legal-page";
import { pageMeta } from "~/meta";

export const Route = createFileRoute("/terms")({
  head: () =>
    pageMeta(
      "Terms of Service - JAgentDesk",
      "Terms for the official JAgentDesk Relay and hosted JAgentDesk Hub services.",
      "/terms",
    ),
  component: Terms,
});
...
function Terms() {
  return (
    <LegalPage title="Terms of Service" lastUpdated="August 29, 2026">
      <p>
        These Terms govern the official services operated at jagentdesk.local, relay.jagentdesk.local, and
        hub.jagentdesk.local. By using the official relay or hosted Hub, you agree to them. Our{" "}
        <a href="/privacy">Privacy Policy</a> explains how those services process data.
      </p>

      <section>
        <h2>Who provides the services</h2>
        <JAgentDeskLegalIdentity />
      </section>

      <section>
        <h2>JAgentDesk&apos;s open-source software</h2>
        <p>
          JAgentDesk is open-source software licensed under the Apache License 2.0. You can install,
          modify, and self-host it under that license without purchasing JAgentDesk Hub or using the
          official relay.
        </p>
        <p>
          These Terms do not replace or restrict the open-source license. They apply only to
          services operated by JAgentDesk. A self-hosted Hub or relay is operated by whoever hosts it.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          The relay is an optional service that connects JAgentDesk clients to your daemon without
      ...
      <section>
        ...
        <p>
          ...
          You give JAgentDesk only the permission needed to receive, transmit, store, and process that
      ...
      <section>
        ...
        <p>
          Stripe processes payments. JAgentDesk does not store complete payment-card details. Nothing in
      ...
      <section>
        ...
        <p>
          JAgentDesk can connect to services such as GitHub, Slack, Discord, Linear, Anthropic, and
          OpenAI. Those services have their own terms and privacy policies. JAgentDesk is not responsible
      ...
      <section>
        ...
        <p>
          ...
          without implied warranties. JAgentDesk is not liable for indirect or consequential losses
