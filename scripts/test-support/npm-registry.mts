...
export async function startNpmRegistry(packages: FixturePackage[]) {
  const root = await mkdtemp(path.join(tmpdir(), "jagentdesk-npm-registry-"));
...
export function npmPluginPackages() {
  const files = {
    ...
    "index.server.ts": `import value from "jagentdesk-fixture-dependency";
export default function contribute() {
  ...
  return [
    {
      name: "jagentdesk-fixture-dependency",
      version: "1.0.0",
      files: { "index.js": 'module.exports = "dependency loaded";' },
    },
    {
      name: "jagentdesk-fixture-plugin",
      version: "1.0.0",
      files,
    ...
    {
      name: "@jagentdesk-fixture/review",
      version: "2.0.0",
      files,
      dependencies: { "jagentdesk-fixture-dependency": "1.0.0" },
      peerDependencies: { "@jagentdesk/plugin": "*" },
    },
  ];
}
