...
export function createButtonExamples(
  ...
  async function refreshWorkspace() {
    // Return the real operation's promise: JAgentDesk supplies pending, double-press prevention, and errors.
    await client.jagentdesk.workspaces.ref(workspaceId).refresh();
    refreshes += 1;
    if (mode === "action") {
