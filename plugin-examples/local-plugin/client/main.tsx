...
import { ExternalLink } from "@jagentdesk/plugin/client/ui";
...
export function ExamplePanel({
  ...
  const handleOpenBrowser = useCallback(() => {
    openBrowser?.({ url: "https://jagentdesk.local/docs/plugins", workspaceId });
  }, [openBrowser, workspaceId]);

  return (
    <View style={styles.screen}>
      <Text style={styles.title}>Workspace plugin panel</Text>
      <ExternalLink href="https://jagentdesk.local/docs/plugins">Plugin documentation</ExternalLink>
      {openBrowser ? (
