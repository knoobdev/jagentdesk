...
This example implements the behavior proposed in JAgentDesk PR #3751 as a plugin. It recognizes
...
calls return `undefined`, leaving JAgentDesk's original timeline entry unchanged.
...
the authoritative projected tail first. The renderer validates `data` before JAgentDesk mounts the
component.
