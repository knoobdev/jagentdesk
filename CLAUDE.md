...
- `packages/website` — Marketing site (jagentdesk.local)
...
| [docs/simulators.md](docs/simulators.md)                             | iOS simulator fleet — input backends (idb/Maestro), headless vs Simulator.app, JPEG frame sizing, device mockups               |
