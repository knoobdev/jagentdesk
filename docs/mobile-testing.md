...
**Use the connection mode required by the test.** Local tests use `127.0.0.1:6768`; remote-pairing tests use the real Tailscale offer and six-digit verification flow. There is no relay fallback.
